# -*- coding: utf-8 -*-
"""
Created on Tue Jun 20 09:56:39 2023
...
arquivo = r'tarifas-homologadas-distribuidoras-energia-eletrica.csv'

tabela_oracle = 'GD_TARIFAS_ANEEL'
...
# Colunas String
colunas_str = ['DscREH','SigAgente','NumCNPJDistribuidora','DatInicioVigencia','DatFimVigencia','DscBaseTarifaria','DscSubGrupo','DscModalidadeTarifaria','DscClasse','DscSubClasse','DscDetalhe','NomPostoTarifario','DscUnidadeTerciaria','SigAgenteAcessante']

# Colunas Float
colunas_float=['VlrTUSD','VlrTE']

# Colunas Data
colunas_data=['DatGeracaoConjuntoDados','DatInicioVigencia','DatFimVigencia']
